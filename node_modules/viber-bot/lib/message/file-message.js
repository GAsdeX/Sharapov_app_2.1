...
function FileMessage(url, sizeInBytes, filename, optionalKeyboard, optionalTrackingData, timestamp, token) {
	this.url = url;
	this.sizeInBytes = sizeInBytes;
	this.filename = filename;

	FileMessage.super_.apply(this, [REQUIRED_ARGUMENTS, optionalKeyboard, optionalTrackingData, timestamp, token]);
}
