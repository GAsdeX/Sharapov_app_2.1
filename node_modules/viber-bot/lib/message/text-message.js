...
function TextMessage(text, optionalKeyboard, optionalTrackingData, timestamp, token) {
	this.text = text;

	TextMessage.super_.apply(this, [REQUIRED_ARGUMENTS, optionalKeyboard, optionalTrackingData, timestamp, token]);
}
