...
function StickerMessage(stickerId, optionalKeyboard, optionalTrackingData, timestamp, token) {
	this.stickerId = stickerId;

	StickerMessage.super_.apply(this, [REQUIRED_ARGUMENTS, optionalKeyboard, optionalTrackingData, timestamp, token]);
}
