...
function PictureMessage(url, optionalText, optionalThumbnail, optionalKeyboard, optionalTrackingData, timestamp, token) {
	this.url = url;
	this.text = optionalText || null;
	this.thumbnail = optionalThumbnail || null;

	PictureMessage.super_.apply(this, [REQUIRED_ARGUMENTS, optionalKeyboard, optionalTrackingData, timestamp, token]);
}
