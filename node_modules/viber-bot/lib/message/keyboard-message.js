...
function KeyboardMessage(keyboard, optionalTrackingData, timestamp, token) {
	KeyboardMessage.super_.apply(this, [REQUIRED_ARGUMENTS, keyboard, optionalTrackingData, timestamp, token]);
}
